    ...
    return (
        ...
        <div className="hero-content text-start ">
          <div className="lg:w-1/2 lg:mr-52">
            <h1 className="mb-5 text-6xl font-bold uppercase"><span className='text-purple-500'>Sell</span> your  <br /> <span className='text-purple-500'>old</span> phone Today</h1>
